...
class AddWasher extends React.Component {
    ...
    render() {
        return (
            <Modal trigger={<Button color='green' onClick={this.handleModalOpen}>Add Machine</Button>} open={this.state.modalOpen} onClose={this.handleModalClose} style={inlineStyle.modal}>
